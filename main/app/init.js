...
function detectTouch(){
    if (navigator.maxTouchPoints > 0){
        const estiloMovil = document.querySelector('link[href="/webapp/main/css/css/responsive.css"]');
		estiloMovil.media = 'screen'; // Habilitar la hoja de estilo móvil
		versionMovil=true;
        console.log("Entra en táctil")
    }
    else{
        const estiloEscritorio = document.querySelector('link[href="/webapp/main/css/css/styloIndex.css"]');
